...
description: Analyze session history and CGX notes to propose workflow improvements; use after implementation sessions to capture recurring friction.. Use when the user asks about conductor improve or mentions $conductor-improve.
---
